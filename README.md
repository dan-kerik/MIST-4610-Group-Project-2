...
**Question 1:**
In the United States, what are the highest and lowest rates of youth tobacco use across different states? For those who are youth tobacco users, what is their status?
##
...
This question is tied to the dataset because the dataset retrieved contains information regarding the use, exposure, and knowledge of tobacco among middle school and high school youth. By addressing this question, our analysis will contribute to a more targeted approach to tackling youth tobacco use, potentially leading to more effective public health strategies and better health outcomes.

##
**Question 2:**
In the United States, how has the average rate of youth tobacco use changed over the years, and are there trends or shifts? Of the youth tobacco users, are there different trends and shifts based on gender?
##
...
**Visualization 1.1**: State-Specific Youth Tobacco Rates
...
**Visualization 1.2**: Youth Tobacco Users Status
...
These visualizations were designed to show insights into the geographic and categorical aspects of youth tobacco use to help organizations or local governments identify key prevention areas.

**Visualization 2.1**: Historical Trend in Youth Tobacco Use
 ...
 - Forecasting: To help understand potential future trends based on the historical data a forecast feature was applied. This helps predict future rates of tobacco use and offers insights into rates if they are expected to fall, rise or stabilize
...
**Visualization 2.2**: Historical Trend in Youth Tobacco Use By Gender
